...
namespace botAPI.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new MetodoGeradorPalpites { Id = 3, Nome = "Vencedor do Encontro", Versao = "1.0", Descricao = "Para definir quem sera o vencedor da partida em termpo regulamentar", Condicoes = "baseado em 4 características para definir quem tem a maior probabilidade de vencer, sendo eles posse de bola,Precisão dos passes,gols e jogos sem sofre gol" },
